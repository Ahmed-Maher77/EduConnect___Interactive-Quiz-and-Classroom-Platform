...
import { useValidationSchema_TeacherLogin } from "../../../utils/form-validation/useValidationSchema_TeacherLogin";
import BackButton from "../../BackButton/BackButton";
import LoginMethodToggle from "./LoginMethodToggle/LoginMethodToggle";
...
const TeacherLogin = () => {
	const formik = useValidationSchema_TeacherLogin();
	...
	const loginPlaceholder = isEmail ? "Email address" : "Teacher ID";
	...
	return (
		<div className="Teacher-Login relative">
			{/* ===================== Back Button ===================== */}
			...
			<header className="flex flex-col items-center gap-4">
				<SectionHeading
					title="Teacher Login"
					subtitle="Access your dashboard to manage your classes, quizzes and students"
			...
			{/* ===================== Form ===================== */}
			<form
				className="teacher-login-form flex flex-col gap-5 w-full max-w-[650px] mx-auto white-bg p-6 lg:p-8 pt-20 lg:pt-20 rounded-lg light-shadow relative mt-10"
